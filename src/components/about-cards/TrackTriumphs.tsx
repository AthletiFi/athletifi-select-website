      ...
      <div className="blue_linear_gradient bg-blue_linear_gradient after:absolute relative lg:py-16 py-5 md:py-10 sm:mt-6 z-0  after:contents-[''] after:inset-0 after:p-[1px] after:rounded-[30px] rounded-[30px]">
        ...
        >
          <h2 className='p-[15px] font-HelveticaNeueMedium md:text-5xl text-[26px] sm:text-4xl text-[#FDFEFF] font-medium leading-[30px] relative z-20 text-center md:mb-4'>
            ...
            Track Triumphs with Your Personalized Soccer Card
          ...
          AthletiFi's Digital Player Cards are revolutionizing how young athletes showcase their skills and achievements. Each participant in our programs is equipped with a unique digital card, a dynamic representation of their soccer journey. These cards vividly display the player's skills, achievements, and progress, serving as a living testament to their hard work and dedication. They encompass key statistics, game highlights, and personal milestones, making them a valuable tool for players to reflect on their journey and share their accomplishments with others, including potential recruiters.
          </p>
        </div>
      </div>
    </div>
