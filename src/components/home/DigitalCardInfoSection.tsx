      ...
      <div className='container md:max-w-full xl:max-w-[1140px] 2xl:max-w-[1320px] mx-auto relative z-10'>
        <div className="blue_linear_gradient relative after:absolute flex justify-center flex-col items-center after:contents-[''] after:inset-0 after:p-[1px] after:rounded-[30px] rounded-[30px]">
          <div className='mb-4'>
            ...
            <p
              ...
              data-aos-offset='200'
            >
              AthletiFi Select was the testing ground for <strong>Pleyr</strong>, our new gamified video platform. 
              Players get access to the <strong>Team Video Vault</strong>, allowing them to clip their own highlights, build their digital player card, and unlock rewards through our gamified engagement streaks.
            </p>
        ...
        <div className="flex lg:justify-center justify-center items-center mt-5 z-50">
          <Link href="/about-cards">
            <BlueButton text="See the Tech behind the Team" />
          </Link>
        </div>
      </div>
    </section>
