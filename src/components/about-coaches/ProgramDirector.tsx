...
const ProgramDirector = () => {
  const directorImage = 'club-director-rash';
      ...
      <div className='container md:max-w-full xl:max-w-[1140px] 2xl:max-w-[1320px] mx-auto px-3 sm:py-2 z-10 relative'>
        <div className='flex lg:flex-row flex-col-reverse justify-between'>
          <div className='lg:w-5/12 xl:w-[531px] min-[1530px]:w-[40%] w-9/12 sm:w-3/5 mx-auto lg:ms-0  mt-6 sm:mt-8 lg:mt-0'>
            ...
            >
              <Image
                src={`/assets/img/webp/${directorImage}.webp`}
                width={1200}
                height={1200}
                alt='Rash Ibrahim'
              />
          ...
          <div className='lg:w-1/2 xl:w-[506px] min-[1530px]:w-1/2 '>
            ...
            >
              ...
              <p className='font-Segoe font-normal text-md leading-7 text-[#FDFEFF] text-center mx-auto lg:ms-0 min-[1530px]:me-0 lg:text-start md:max-w-[506px] xl:w-auto opacity-80 m-0 font-sans sm:pt-4'>
                Program Director
              </p>
              <p className='font-normal font-Segoe text-md leading-7 text-[#FDFEFF] text-center mx-auto lg:ms-0 min-[1530px]:me-0 lg:text-start md:max-w-[506px] xl:w-auto opacity-80 m-0 font-sans sm:pt-4'>
                Rash Ibrahim brings over a decade of experience in program development, operations, and athlete mentorship to AthletiFi Select. A lifelong soccer player and student of the game, Rash oversees the day-to-day operations of the club, manages relationships with families and partner organizations, and ensures every player has a clear path to reaching their potential. He joined AthletiFi Select ahead of the Fall 2026 season and has been instrumental in establishing the club's new home at Arcadia University and shaping the program's next chapter.
              </p>
            </div>
          </div>
        </div>
